...
Banco de dados usado na API [SP Medical Group](https://github.com/Chingling152/WebApi-SPMedGroup)
...
* **1.5. [Procedures](#Procedures)**   
  1.5.1. [Procedures de Alteração](#Procedures-de-alteração)  
...
### Views do usuario   
Você pode criar suas proprias views no arquivo [Views_do_usuario.sql](#https://github.com/Chingling152/SQL-SPMedGroup/blob/master/Essenciais/2-Views.sql) (Ou não.... você pode fazer tudo em um arquivo se quiser), não há muito o que dizer, já existem views o suficiente no banco de dados (a não ser que você queira filtrar mais).  
...
* **AtualizarPaciente**  
Altera todos os valores do Paciente e do Usuario que ele referencia (algoritmo secreto hihi)
*Parametros* :  
...
* **AtualizarMedico**  
Altera todos os valores do Medico e do Usuario que ele referencia
*Parametros* :  
...
* **AtualizarClinica**  
 Atualiza todas as informações de uma clinica selecionado pelo ID
*Parametros* :  
...
* **AtualizarConsulta**
Atualiza os valores de uma consulta (não altera o paciente. Não faz sentido mudar o paciente de uma consulta)
*Parametros* : 
